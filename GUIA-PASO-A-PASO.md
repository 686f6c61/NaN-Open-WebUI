...
Cada vez que ejecutes `docker compose up -d`, Docker comprobara si hay una imagen nueva
y la usara si existe. Tus chats y ajustes se conservan.
...
2. Configuralo como proveedor compatible con OpenAI:
   ...
   - Modelo: por ejemplo `glm5.2` para coding agéntico, o `mimo-v2.5` / `qwen3.6`
